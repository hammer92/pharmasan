  ...
  data () {
    return {
      listado: {
        current_page: 1,
        data: [],
        first_page_url: 'http://localhost/api/clientes?page=1',
        from: 1,
        last_page: 0,
        last_page_url: 'http://localhost/api/clientes?page=11516',
        next_page_url: 'http://localhost/api/clientes?page=2',
        path: 'http://localhost/api/clientes',
        per_page: 10,
        prev_page_url: null,
        to: 0,
        total: 0
